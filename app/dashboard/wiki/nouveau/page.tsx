...
import { ChevronLeft, Save, Loader2, Type, AlignLeft, Layout } from 'lucide-react';
...
export default function NouveauWikiPage() {
  ...
  async function onSubmit(e: React.FormEvent<HTMLFormElement>) {
    ...
    try {
      ...
      if (error) {
        // ICI : On affiche l'erreur en clair même si c'est un objet
        ...
        <form onSubmit={onSubmit} className="space-y-6">
          <div className="bg-white p-8 rounded-[2.5rem] border shadow-sm space-y-6">
            <div className="space-y-2">
              ...
              <Input name="titre" placeholder="Ex: Code de la porte d'entrée" required className="h-12 rounded-xl bg-slate-50 border-none font-bold" />
            </div>
            ...
            <div className="space-y-2">
              <Label>Contenu</Label>
              <Textarea name="contenu" placeholder="Écrivez ici..." required className="min-h-[200px] rounded-xl bg-slate-50 border-none font-medium" />
            </div>
